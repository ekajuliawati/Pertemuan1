fun main() {
    // var yaitu nilai yang bisa di ubah selama di eksekusi
    var varVariabel: Int
    varVariabel = 56 // memberi nilai pertama pada varVariabel
    println("Pemberian nilai pertama pada varVariabel = " + varVariabel)
    varVariabel = 78 // memberi nilai kedua pada varVariabel
